...
public Statement s;
 ...
 public ResultSet rs;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modification of Teacher Records");
...
catch(Exception e)
{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       int n=Integer.parseInt(TNo.getText());
try
{   
   Q="update teacher set tno = "+ TNo.getText() +", tname ='"+TName.getText()+"' ,taddress ='"+TAddress.getText()+"', tsalary ="+TSalary.getText()+", tdoj = '"+TDOJ.getText()+"', tgrade ='"+TGrade.getText()+"' where tno="+n+"";
   s.executeUpdate(Q);
